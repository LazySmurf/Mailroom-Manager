...
{
    public partial class DelPBagForm : Form
    {
        ...
        private async void DelBagBtn_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            if (ConfirmDelete == DialogResult.Yes)
            {
                ...
                DeleteParcelsFromBag(json.ParcelNos);
            }
            else
            {
        ...
        public async void DeleteParcelsFromBag(ICollection<string> parcels)
        {
        ...
        {
            InitializeComponent();
            MouseDown += DelPBagForm_MouseDown;
            MouseMove += DelPBagForm_MouseMove;
            TitleLabel.MouseDown += DelPBagForm_MouseDown;
            TitleLabel.MouseMove += DelPBagForm_MouseMove;
        ...
        private async void DelPBag_Load(object sender, EventArgs e)
        {
            CurveBorder(20);
            ...
            LetterCountLbl.Text = json.ParcelNos.Count.ToString();
        ...
        //Move Form
        private void DelPBagForm_MouseDown(object sender, MouseEventArgs e)
        {
            MouseDownEvents(e);
        }

        private void DelPBagForm_MouseMove(object sender, MouseEventArgs e)
        {
            MouseMoveEvents(e);
        }
